...
# module references:
# $rocket_module_name, synchronizer, mem_reset_control, ethernet, sdc_controller, uart, ethernet_stlv7325
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  connect_bd_net -net mem_areset [get_bd_pins mem_axi_reset_sync/dout] [get_bd_pins mig_7series_0/aresetn]
